...
//transactions
Route::group(['prefix' => 'dashboard', 'middleware' => ['user_status']], function () {
...
//routes management
Route::group(['middleware' => ['permission:View Routes|View Places|View Termini|View Termini Users', 'user_status']], function () {
