...
<div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__shake" src="{{ asset('/images/logos/white-logo.png') }}" alt="Komiut Logo" height="60"
             width="60">
    </div>
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link toggleMenu" data-widget="pushmenu" href="#" role="button"><i class="fas fa-bars"></i></a>
            </li>
        </ul>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    @endif
                    @if(auth()->user()->can('View Saccos') || auth()->user()->can('View Sacco Members') || auth()->user()->can('View Sacco Routes') || auth()->user()->can('View Sacco Vehicles'))
                    ...
                    @endif
                    @if(auth()->user()->can('View Vehicles') ||auth()->user()->can('View Vehicle Users') || auth()->user()->can('View Vehicle Locations') || auth()->user()->can('View Seat Settings'))
