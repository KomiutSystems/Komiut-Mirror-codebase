...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><i class='fas fa-coins'></i> <b>All</b> Transactions</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        $(document).ready(function () {
            ...
            var table = $('.table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'vehicle.plate', name: 'vehicle.plate', defaultContent: 'N/A'},
                    {data: 'amount', name: 'amount'},
                    {data: 'name', name: 'name',  defaultContent: 'N/A'},
                    {data: 'phone', name: 'phone', defaultContent: 'N/A'},
                    {data: 'vehicle.sacco.name', name: 'vehicle.sacco.name', defaultContent: 'N/A'},
