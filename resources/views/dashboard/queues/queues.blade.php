...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5><i class='fas fa-flag'></i> Queues</h5>
                </div><!-- /.col -->
                    ...
                    <form method="POST" action="{{ url('queues/add') }}" class="row">
                        ...
                        <div class='col-sm-12'>
                            <div class='alert border'>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="choice" id="choice2"
                                        value="1">
                        ...
                        <div class="col-sm-12 schedule_time d-none">
                            ...
                            <input type='date' id='schedule_time' name='schedule_time' class='form-control'
                ...
                ajax: {
                    ...
                    processResults: function(data) {
                        return {
                            results: $.map(data, function(item) {
                                return {
                                    text: item.from.name + " - " + item.to.name + ' (' + item
                                        .name + ')',
                                    id: item.id
                                }
                            })
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            switch (data.status) {
                                case "Pending":
                                    return '<span class="badge bg-secondary">' + data.name +
                                        '</span>';
                                case "Active":
                                    return '<span class="badge bg-primary">' + data.name +
                                    '</span>';
                                case "Suspended":
                                    return '<span class="badge bg-warning">' + data.name +
                                    '</span>';
                                case "Completed":
                                    return '<span class="badge bg-success">' + data.name +
                                    '</span>';
                                default:
