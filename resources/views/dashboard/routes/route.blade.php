...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><i class='fas fa-user-lock'></i> Route</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                            ...
                            <div class="card-body box-profile">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class='table-responsive'>
                                        <table
                                            class="table align-items-center table-flush vehicles w-100">
                                            <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Place</th>
                ...
                $.ajax({
                    ...
                    if (data.errors) {
                        if (data.errors.route_id) {
                            $('#placeModal .feedback').html("<i class='fas fa-exclamation-circle'></i> " + data.errors.route_id + "<br>");
                        }
                        if (data.errors.route_id) {
                            $('#placeModal .feedback').html("<i class='fas fa-exclamation-circle'></i> " + data.errors.route_id + "<br>");
                        }
                        if (data.errors.place) {
                            $('#placeModal .feedback').html("<i class='fas fa-exclamation-circle'></i> " + data.errors.place + "<br>");
                        }
                    } else if (data.error) {
