...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5><i class='fas fa-user'></i> <b>My</b> Profile</h5>
                </div><!-- /.col -->
                            ...
                            <div class="tab-content">
                                    ...
                                    <form class='row edit-profile' method='POST' action="{{ url('profile/change') }}">
                                        ...
                                        <div class='col-sm-6 col-md-4 p-2'>
                                            ...
                                            <input type='date' name='dob' id='dob' class='form-control'
                                                ...
                                                placeholder="D.O.B" required readonly>
                                        </div>
                                        <div class='col-sm-6 col-md-4 p-2'>
                                            <b>Gender:</b><br>
                                ...
                                <div class="tab-pane pt-4" id="messages" role="tabpanel"
                                    ...
                                    <form method="POST" class='change-password'
                                        action="{{ url('profile/change/password') }}">
                                        @csrf
                ...
                $.ajax({
                    ...
                    if (data.errors) {
                        ...
                        if (data.errors.gender) {
                            $('.edit-profile .feedback').append(
                                "<i class='fas fa-exclamation-circle'></i> " + data.errors
                                .gender + "<br>");
                        }
                        if (data.errors.dob) {
                            $('.edit-profile .feedback').append(
                                "<i class='fas fa-exclamation-circle'></i> " + data.errors.dob +
                                "<br>");
                        }
                    } else if (data.error) {
                        $('.edit-profile .feedback').html(
