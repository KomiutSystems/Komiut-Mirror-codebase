...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5><i class='fas fa-sliders-h'></i> <b>Seat</b> Arrangement</h5>
                </div><!-- /.col -->
                <div class="col-sm-6 text-right">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('home') }}">Home</a></li>
                        <li class="breadcrumb-item active"><a href="{{ url('vehicles/seats/settings') }}">Seat Settings</a>
                        </li>
                                ...
                                <div class="tab-pane active pt-4" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    <div class='row'>
                                        ...
                                        <div class='col-sm-6 col-md-4 p-2'>
                                            <b>Date Created:</b><br>
                                            <b
                                                class='text-muted'>{{ \Carbon\Carbon::parse($seat->created_at)->diffForHumans() }}</b>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class='col-sm-4 text-right'>
                                            @can('Add Seat Settings')
                                                <span class="btn btn-primary btn-sm btn-launch-modal mb-1" data-toggle="modal"
                                                    data-target="#vehicleModal"><i class='fas fa-plus'></i> Add Settings
                                                </span>
                                            @endcan
                                        </div>
                                    </form>
            ...
            $('#vehicleModal .btnSave').click(function() {
                ...
                $.ajax({
                    ...
                    if (data.errors) {
                        ...
                        if (data.errors.row) {
                            $('#vehicleModal .feedback').html(
                                "<i class='fas fa-exclamation-circle'></i> " + data.errors.row +
                                "<br>");
                        }
