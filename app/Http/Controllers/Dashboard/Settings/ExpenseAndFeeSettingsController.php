...
class ExpenseAndFeeSettingsController extends Controller
{

    public function __construct()
    {
        $this->middleware('auth');
        $this->middleware(['permission:View Expense And Fees Settings']);
    }

    public function index(){
        $sacco = Sacco::find(Auth::user()->sacco_id);
        return view("dashboard.settings.fees_and_expenses_settings", @compact('sacco'));
